...
#         print(f"Group 1: Tops: {[shape.top for shape in group1.shapes]}, Lefts: {[shape.left for shape in group1.shapes]}")
#         print(f"Group 2: Tops: {[shape.top for shape in group2.shapes]}, Lefts: {[shape.left for shape in group2.shapes]}")
